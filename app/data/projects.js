  ...
  rendimiento: {
    ...
    slides: [
         ...
         ══════════════════════════════════════════ */
      {
        ...
        content: { es:"Los supervisores de un contact center necesitan responder una pregunta simple cada día: **¿cómo rinde mi equipo?** La plataforma tenía los datos — *tickets resueltos, tiempos de respuesta, satisfacción del cliente* — pero los presentaba **dispersos en categorías que no reflejaban cómo los supervisores piensan su operación**. El resultado: exportaban todo a Excel para armar sus propios reportes.", en:"Contact center supervisors need to answer one simple question every day: **how is my team performing?** The platform had the data — *resolved tickets, response times, customer satisfaction* — but presented it **scattered across categories that didn't reflect how supervisors think about their operation**. The result: they exported everything to Excel to build their own reports." },
        tags: ["Analytics","Data Viz","Data Definition","Phased Delivery","Contact Center"],
        bottomImage: "/images/rendimiento_challenge_illustration.svg",
      },
      {
        phase: "context",
        icon: "🔥", title: { es:"El Problema", en:"The Problem" },
        ...
        bottomImage: "/images/rendimiento_5_problems.svg",
      },
      {
        phase: "context",
        icon: "🖥️", title: { es:"Estado previo", en:"Previous state" },
